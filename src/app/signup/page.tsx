...
export default function SignupPage() {
  ...
  function onSubmit(e: React.FormEvent) {
    e.preventDefault();
    alert("Sign up is not implemented yet — coming soon!");
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-200 dark:from-gray-950 dark:to-gray-900">
      <form onSubmit={onSubmit} className="w-full max-w-md bg-white dark:bg-gray-950 rounded-3xl shadow-lg p-8 border border-gray-200 dark:border-gray-800 space-y-4">
        ...
        <button className="w-full rounded-xl px-5 py-3 font-medium bg-indigo-600 text-white hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600">Sign up</button>
        <p className="text-sm text-gray-500 dark:text-gray-400">Already have an account? <a href="/login" className="underline">Log in</a></p>
      </form>
    </div>
  );
}
